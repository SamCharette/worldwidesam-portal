...
const apps = [
  ...
  { name: "Neon Cycle Grid", category: "games", kind: "light-cycle arcade", code: "NC-05", publicUrl: "https://worldwidesam.net/neon-cycle-grid/", localPort: 4325, radius: 7.05, speed: -0.059, size: 0.4, start: 3.2, color: 0x5cf2df, summary: "A fast 3D light-cycle arena where every glowing trail becomes the next wall.", highlights: ["Four-rider light-cycle arena", "Trails become solid hazards", "Exact portal proxy route to the standalone service"] },
  ...
  { name: "Traceglass", category: "tools", kind: "request observatory", code: "TG-19", publicUrl: "https://traceglass.worldwidesam.net/", radius: 8.7, speed: -0.039, size: 0.46, start: 1.9, color: 0x70b7ff, summary: "Watch one public website request unfold through DNS, TLS, redirects, response evidence, and inert dependency declarations.", highlights: ["Animated request journey", "Evidence-first timing and response posture", "Declared dependencies are parsed, never contacted"] },
  ...
  { name: "ProCon", category: "tools", kind: "decision workbench", code: "PC-16", publicUrl: "https://procon.worldwidesam.net/", radius: 6.65, speed: 0.051, size: 0.4, start: 4.7, color: 0x4f76d9, summary: "A deterministic workbench for mapping personal decisions through weighted consequences, explicit probabilities, exact outcomes, and reversible what-if assumptions.", highlights: ["Seven-step mobile and desktop workflow", "Exact weighted outcome math", "Browser-local decisions with explicit import and export"] },
  { name: "Idea Graph", category: "tools", kind: "visual thinking partner", code: "IG-18", publicUrl: "https://ideagraph.worldwidesam.net/", radius: 8.1, speed: 0.043, size: 0.44, start: 0.15, color: 0x5266d5, summary: "Begin with one thought, explore useful directions with an assistant, and preserve the shape and history of the idea as it grows.", highlights: ["Grow one thought into a visual map", "Keep or dismiss assistant-suggested directions", "Browser-local graphs with JSON export"] },
  { name: "Sudbury Regreening Time Machine", category: "tools", kind: "environmental time machine", code: "SR-17", publicUrl: "https://sudburyregreening.worldwidesam.net/", localPort: 4326, radius: 7.4, speed: -0.047, size: 0.45, start: 5.25, color: 0x8fbf72, summary: "Travel through Greater Sudbury's regreening history by pairing recorded interventions with Landsat-observed vegetation change.", highlights: ["Compare 1984 with six audited satellite composites", "Explore City planting and liming records from 1978–2025", "Trace every claim through the built-in source register"] },
  { name: "Permit Pulse", category: "tools", kind: "permit activity explorer", code: "PP-20", publicUrl: "https://permitpulse.worldwidesam.net/", radius: 9.35, speed: 0.035, size: 0.43, start: 2.8, color: 0xd93660, summary: "Explore where Greater Sudbury permit activity concentrated, how permit categories changed, and which areas broke from their own history.", highlights: ["Absolute and unusually active hotspot maps", "Residential, commercial, institutional, and industrial trends", "Source-forward 1982–2025 permit snapshot"] },
...
const systems = [
  { id: "games", name: "Games", kind: "cabinet of playable experiments", code: "GM", publicUrl: "https://games.worldwidesam.net/", localPort: 4323, radius: 5.8, speed: 0.052, size: systemPlanetSize("games"), start: 0.1, color: 0x2c7892, summary: "Arcade, puzzle, strategy, gravity toys, and tiny management games.", highlights: ["Clawdia Cabinet", "Hex", "Clawdtris", "Circuit Snap", "Neon Cycle Grid", "Orbital Slingshot", "One Bullet Dungeon", "Dungeon Desk"] },
  { id: "tools", name: "Tools", kind: "utility surfaces", code: "TL", radius: 8.0, speed: -0.041, size: systemPlanetSize("tools"), start: 2.75, color: 0x5f7b42, summary: "Dashboards and helper apps.", highlights: ["Mission Control", "Traceglass", "Decisions Please", "ProCon", "Idea Graph", "Sudbury Regreening Time Machine", "Permit Pulse"] },
