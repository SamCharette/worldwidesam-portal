...
const systems = [
  ...
  { id: "tools", name: "Tools", kind: "utility surfaces", code: "TL", radius: 8.0, speed: -0.041, size: systemPlanetSize("tools"), start: 2.75, color: 0x5f7b42, summary: "Dashboards and helper apps.", highlights: ["Mission Control", "Traceglass", "Decisions Please", "ProCon", "Idea Graph", "Sudbury Regreening Time Machine"] },
