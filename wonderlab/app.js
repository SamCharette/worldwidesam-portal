import { CATEGORIES, appById, validateCatalog } from './catalog.js?v=20260725a';
import { createSelectionState } from './state.js?v=20260725a';
import { resolveAppUrl, resolveOrbitUrl } from './url-resolver.js?v=20260725a';
import {
  markSelections,
  renderApp,
  renderCategories,
