import { CATEGORIES, appById, validateCatalog } from './catalog.js?v=20260722a';
import { createSelectionState } from './state.js?v=20260722a';
import { resolveAppUrl, resolveOrbitUrl } from './url-resolver.js?v=20260722a';
import {
  markSelections,
  renderApp,
  renderCategories,
