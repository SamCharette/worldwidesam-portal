...
6. Keep the tone concise, personal, and project-log shaped. Mention what changed, what is interesting, or what is worth doing next. It is okay to include a compact list of notable work from the day, such as EEMS, backups, the RPG atlas, Marvel Runner, One Bullet Dungeon, or another project signal, when that helps readers understand what is new.
